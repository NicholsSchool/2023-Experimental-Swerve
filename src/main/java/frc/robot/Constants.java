...
public final class Constants {
  ...
  public static final class DriveConstants {
    ...
    // Distance between front and back wheels (inches to meters).
    public static final double kWheelBase = Units.inchesToMeters(24.5);

    // Constructs a swerve drive kinematics object based on robot characteristics.
    ...
    // Angular offsets of the modules relative to the chassis after calibration.
    public static final double kFrontLeftChassisAngularOffset = -Math.PI / 2;
    public static final double kFrontRightChassisAngularOffset = 0;
    public static final double kBackLeftChassisAngularOffset = Math.PI;
    public static final double kBackRightChassisAngularOffset = Math.PI / 2;

    // REV MAXSwerve Module CAN IDs
    ...
    public static final int kBackRightDrivingCanId = 12;
    public static final int kBackRightTurningCanId = 13;
  ...
  public static final class ModuleConstants {
    ...
    // A pinion gear with more teeth drives faster (12T, 13T, or 14T).
    ...
    public static final double kDrivingMotorFreeSpeedRps = NeoMotorConstants.kMaxFreeSpeedRpm / 60;
